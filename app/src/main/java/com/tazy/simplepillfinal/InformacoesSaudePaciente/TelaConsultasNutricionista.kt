...
@Composable
fun TelaConsultasNutricionista(navController: NavController) {
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            // Título
            Text(
                text = "Suas consultas com nutricionista",
                fontSize = 28.sp,
            ...
            // Botão oval único
            BotaoOval(texto = "Próximas consultas") {
                navController.navigate(AppRoutes.TelaProximasConsultasNutricionista)
            }

            Spacer(Modifier.weight(1f))

            // Rodapé com logo + voltar
            Image(
