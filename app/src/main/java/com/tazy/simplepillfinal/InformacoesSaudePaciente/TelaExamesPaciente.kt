// app/src/main/java/com/tazy/simplepillfinal/ui/screens/TelaExamesPaciente.kt
...
@Composable
fun TelaExamesPaciente(navController: NavController) {
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            // Botões ovais
            BotaoOval("Próximos exames") {
                navController.navigate(AppRoutes.TelaProximosExamesPaciente)
            }
            BotaoOval("Anteriores") {
                navController.navigate(AppRoutes.TelaExamesAnterioresPaciente)
            }

            Spacer(Modifier.weight(1f))

            // Rodapé: logomarca + voltar
            Image(
